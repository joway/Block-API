...
from oauth.constants import SCOPE_CHOICES, GRANT_TYPE_CHOICES, Scopes
from oauth.generators import generate_client_id, generate_client_secret, token_expire_at_time, grant_expire_at_time, \
    generate_grant_code, generate_refresh_token
...
class TokensManager(models.Manager):
    def create_token(self, app, user, access_token, refresh_token=generate_refresh_token(), scope=None):
...
class Token(models.Model):
    ...
    access_token = models.CharField('access_token', max_length=1024)
    refresh_token = models.CharField('refresh_token', max_length=1024)
