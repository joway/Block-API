...
class OauthTestCase(BaseTestCase):
    def setUp(self):
        ...
        self.client = Application.objects.create(name=self.app_name, description=self.app_desc,
                                                 ...
                                                 owner=self.user, grant_type=GrantTypes.JWT_BEARER)
    ...
    def test_access_token(self):
        ...
        data = {
            ...
            'grant_type': self.grant.application.grant_type
        }
    ...
    def test_refresh_token(self):
        ...
        self.token = Token.objects.create_token(self.client, user=self.user, access_token=generate_access_token())
        data = {
            'client_secret': self.client.client_secret,
            'client_id': self.client.client_id,
